 ...
 * @author tylerbates
 */
public class OrderDaoStubImp implements OrderDao {
    ...
    public OrderDaoStubImp(){
        onlyOrder = new Order();
        onlyOrder.setOrderNum("091520181");
        onlyOrder.setCustomerName("Ted");
        onlyOrder.setArea(new BigDecimal("5"));
        onlyOrder.setDate(LocalDate.of(2018, Month.SEPTEMBER, 15));
        
        fileOrders.put(onlyOrder.getOrderNum(), onlyOrder);
    }
